...
export default function LoginForm({ handleLogin, setEmail, setPassword, email, password }: { handleLogin: (e: React.FormEvent) => void, setEmail: (email: string) => void, setPassword: (password: string) => void, email: string, password: string }) {
    return (
